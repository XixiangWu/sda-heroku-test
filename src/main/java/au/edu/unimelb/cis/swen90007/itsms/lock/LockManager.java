package au.edu.unimelb.cis.swen90007.itsms.lock;
...
public class LockManager {
    ...
    public synchronized void releaseReadLock(Object toLock) { getReadWriteLock(toLock).unlockRead();}
    public synchronized void releaseWriteLock(Object toLock) { getReadWriteLock(toLock).unlockWrite();}
