...
<head>
    ...
    <title>Submit New Appointment</title>
        ...
        <div class="row">
            <form action='' method='post'>
                <div class="col-md-12 pl-0 custom-dropdown-example">
                    ...
                    <fieldset>
                        <select id='issueid' name='issueid' class="custom-select w-100" required>
                ...
                <div class='form-group row'>
                    ...
                    <div class='col-md-12'>
                        <textarea id='description' class='form-control' rows='10' name='description' required></textarea>
                    </div>
                </div>
